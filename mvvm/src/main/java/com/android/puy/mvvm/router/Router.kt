...
class Router private constructor() {
    ...
    fun putBundle(key: String?, bundle: Bundle?): Router {
        bundleData.putBundle(key, bundle)
        return this
    }
    ...
    fun putBoolean(key: String?, value: Boolean): Router {
        bundleData.putBoolean(key, value)
        return this
    }
    ...
    fun putDouble(key: String?, value: Double): Router {
        bundleData.putDouble(key, value)
        return this
    }
